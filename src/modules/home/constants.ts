export const PROJECT_TEMPLATES = [
  {
    ...
    prompt:
      "Build a Netflix-style homepage with a hero banner (use a nice, dark-mode compatible gradient here), movie sections, responsive cards, and a modal for viewing details using mock data and local state. Use dark mode.Make sure you use next themes , because you have shadcn components",
  },
  {
    emoji: "📦",
